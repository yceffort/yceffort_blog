...
exports.default = exports.getFieldsWithFilters = exports.getBasicFields = exports.clearAlgoliaIndex = exports.indexPostsOnAlgolia = exports.preparePosts = exports.splitIntoChunks = exports.upperFirst = exports.pick = void 0;
...
const indexPostsOnAlgolia = (algoliaIndex, posts, chunkSize) => {
...
exports.indexPostsOnAlgolia = indexPostsOnAlgolia;

const clearAlgoliaIndex = algoliaIndex => {
  return new Promise((resolve, reject) => {
...
exports.clearAlgoliaIndex = clearAlgoliaIndex;
...
function () {
  var _ref = _asyncToGenerator(function* (hexo, args, callback) {
    ...
    if (args && !args.n) {
      ...
      try {
        yield clearAlgoliaIndex(algoliaIndex);
      } catch (error) {
    ...
    try {
      yield indexPostsOnAlgolia(algoliaIndex, posts, algoliaChunkSize);
    } catch (error) {
